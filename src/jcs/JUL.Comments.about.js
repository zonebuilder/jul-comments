...
/**
  ...
  @type  Object
  @name  JUL.Comments.about.ui
*/
jul.ns('JUL.Comments.about.ui', {
  tag: 'window',
  id: 'window-about',
  css: 'logo-bg',
  hidden: true,
  ...
  children: [
    ...
    {tag: 'vbox', flex: 1, children: [
      ...
      {tag: 'description',
       html: 'Copyright &copy; 2015 - 2020 <a target="_blank" href="' + ample.$encodeXMLCharacters(JUL.Comments.config.zb_link) + '">The Zonebuilder</a>'},
      {tag: 'description',
...
jul.apply(jul.get('JUL.Comments.about'), /** @lends JUL.Comments.about */ {});
