...
/* generated by JUL Designer version 1.7.1 */
...
/* begin 'JUL Comment System - Main page' UI */
{
	...
	children: [
		{tag: 'toolbar', children: [
			...
			{tag: 'toolbarbutton', id: 'tbutton-save-project', css: 'darky', label: 'Save project', tooltiptext: 'Save project to enable downloading the code'},
			{tag: 'toolbarbutton', id: 'tbutton-download-code', css: 'darkg', label: 'Download code', tooltiptext: 'Download the last saved code'},
			{tag: 'toolbarseparator'}
		]},
		{tag: 'hbox', flex: 1, children: [
			{tag: 'vbox', id: 'vbox-dom', width: 310, children: [
				...
				{tag: 'hbox', children: [
					{tag: 'toolbargrippy'},
					{tag: 'checkbox', id: 'checkbox-separate-file', label: 'separate file, put outside', tooltiptext: 'generate a distinct file for this object and its descendants'},
					{tag: 'textbox', id: 'textbox-put-outside', style: 'width:110px', tooltiptext: 'comma delimited list of members to put separately in the file'}
				]},
				{tag: 'hbox', children: [
					{tag: 'toolbargrippy'},
					{tag: 'checkbox', id: 'checkbox-sort-keys', label: 'sort members', tooltiptext: 'sort properties and methods alphabetically'},
					{tag: 'checkbox', id: 'checkbox-expand-proto', label: 'show prototype', tooltiptext: 'expose object\'s prototype in the generated code'}
				]}
			]},
			{tag: 'splitter'},
			{tag: 'vbox', flex: 1, children: [
...
/* generated by JUL Designer version 1.6 */
