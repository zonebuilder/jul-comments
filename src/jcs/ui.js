...
/* generated by JUL Designer version 1.8.7 */
	...
	children: [
		...
		{tag: 'hbox', flex: 1, children: [
			{tag: 'vbox', id: 'vbox-dom', width: 310, children: [
				...
				{tag: 'toolbar', children: [
					{tag: 'toolbargrippy'},
					{tag: 'toolbarbutton', id: 'tbutton-generate-comments', label: '+/**{ }*/', pack: 'center',
					 tooltiptext: 'Auto-generate comments for the selected items', width: 65},
					{tag: 'toolbarbutton', id: 'tbutton-remove-comments', label: '-/**{ }*/', pack: 'center',
					 tooltiptext: 'Remove comments from the selected items', width: 65},
					{tag: 'toolbarbutton', id: 'tbutton-undo-tree', label: 'Undo', pack: 'center', width: 65}
				]},
	...
	'tree-dom': {
		listeners: {
			select: function () {
				var oThis = this;
				setTimeout(function() {
					var oItems = oThis.selectedItems;
					JUL.Comments.project.onSelectNode(oItems.length ? oItems.item(oItems.length - 1) : null);
				}, 50);
			}
		}
	}
