...
jul.apply(jul.get('JUL.Comments.config'), /** @lends JUL.Comments.config */ {
  /**
    Block comment end
    @type  String
  */
  ...
  */
  fieldTypes: {
    ...
    fileOverview: {
      desc: 'Provides documentation for an entire file', fields: {
        value: 'edit'
      },
      template: '@{field}\t{value}'
    },
  ...
  */
  projectFields: {
    ...
    jslint: {
      desc: '<a href="http://www.jslint.com/" target="_blank">JSLint</a>/<a href="http://jshint.com/" target="_blank">JSHint</a> directives',
       type: 'edit', init: '/* eslint-disable */\n/* globals JUL */\n'
    },
    excludePaths: {
      desc: 'Comma separated paths to exclude', type: 'text'
    },
    useJul: {
      desc: 'Use JUL to wrap around objects', type: 'bool', init: true
    }
  },
  /**
    ...
    @type  Array
  */
  typeSelect: ['Array', 'Boolean', 'Date',
   'Function', 'Null', 'Number', 'Object', 'RegExp', 'String', 'Mixed']
});
