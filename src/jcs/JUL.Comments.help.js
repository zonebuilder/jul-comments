	...
	children: [
		{tag: 'toolbox', children: [
			{tag: 'toolbar', children: [
				...
				{xclass: 'html', tag: 'div', width: 220, style: 'padding:5px 18px 0 0;text-align:right', children: [
					{xclass: 'html', tag: 'a', target: '_blank', href: 'docs/index.html?1462617836024', html: 'Open in a new window'}
				]}
			]}
		]},
		{tag: 'hbox', flex: 1, children: [
			...
			{tag: 'vbox', flex: 1, children: [
				{tag: 'iframe', id: 'iframe-help', flex: 1, src: 'docs/index.html?1462617836024'}
			]}
		]}
	]
};

JUL.apply(JUL.Comments.help, /** @lends JUL.Comments.help */ {
	/**
		Help page URL
		@type	String
	*/
